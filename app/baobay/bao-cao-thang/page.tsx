// app/baobay/bao-cao-thang/page.tsx
"use client";
...
export default function MonthlyReportPage() {
  ...
  const load = useCallback(async (m: string) => {
    ...
    setError(null);
    try {
      setData(await apiGet<MonthlyReportDTO>(`/api/baobay/monthly?month=${m}&spot=${spot}`));
    } catch (err: any) {
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="flex items-end">
            <div className="flex flex-wrap gap-2">
              <a
                href={`/api/baobay/export?month=${month}&spot=${spot}`}
              ...
              <a
                href={`/api/baobay/monthly?month=${month}&format=csv&spot=${spot}`}
