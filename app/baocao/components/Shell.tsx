    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-5 sm:py-8 lg:max-w-6xl">
      ...
      {tabs.length > 0 && (
        <nav className="mb-5 flex gap-2 overflow-x-auto">
          ...
          {/* SỔ TAY: ai cũng cần, không phụ thuộc vai trò — để cuối hàng cho
              khỏi chen vào các tab công việc */}
          <Link
            href="/baocao/huong-dan"
            className={
              pathname === "/baocao/huong-dan"
                ? "shrink-0 rounded-xl bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white"
                : "shrink-0 rounded-xl border border-emerald-300 bg-emerald-50 px-4 py-2.5 text-sm font-medium text-emerald-800 hover:bg-emerald-100"
            }
          >
            📘 Hướng dẫn
          </Link>
