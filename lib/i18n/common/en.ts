...
export const en: CommonTranslation = {
  ...
  spots: {
    ...
    locations: {
      muongHoaSapa: {
        name: "Sapa (Muong Hoa Valley)",
        location: "Lao Cai",
        duration: "90-minute tour",
        highlights: [
          "See Sapa from above",
          "Views of Fansipan Peak",
          "Fly over a sea of clouds",
        ],
        summary:
      ...
      sonTra: {
        ...
        highlights: [
          ...
          "Fly over the sea",
          "Take off from the Son Tra summit",
        ],
        summary:
      ...
      tramTau: {
        ...
        location: "Lao Cai",
        duration: "90-minute tour",
        highlights: ["Fly over the Muong Lo field", "Fly over a sea of clouds"],
        summary:
      ...
      vienNam: {
        ...
        highlights: [
          ...
          "Panoramic views of the Rocky Plateau",
        ],
        summary:
      ...
      doiBu: {
        ...
        location: "Hanoi",
        duration: "3 - 5 hour tour",
        highlights: [
          "A flying site near the capital",
          "Fly over reed-covered hills",
          "Sunset flights",
        ],
        summary:
