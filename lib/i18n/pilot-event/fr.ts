...
export const fr: PilotDict = {
  ...
  fEmergencyPhone: "Numéro d’urgence",
  fEmergencyPhonePh: "Proche / compagnon de vol à contacter en cas d’urgence",
  fSupportPilot: "Pilote/instructeur local accompagnant",
  fSupportPilotHint:
    "Nouveaux pilotes ou pilotes soumis à un vol supervisé : indiquez ici le nom du pilote/instructeur local qui vous accompagnera pendant les vols, pour la sécurité. La direction du site vérifiera l’information auprès des deux parties.",
  fSupportPilotPh: "Nom du pilote/instructeur local",
  fSupportPilotPhonePh: "Numéro de téléphone du pilote/instructeur accompagnant",
  ...
  err: {
    ...
    emergencyPhone: "Veuillez saisir un numéro d’urgence",
