...
export const en: PilotDict = {
  ...
  fEmergencyPhone: "Emergency contact number",
  fEmergencyPhonePh: "Relative / flying buddy to call in an emergency",
  fSupportPilot: "Supporting local pilot/instructor",
  fSupportPilotHint:
    "New pilots or pilots subject to supervised flying: please enter the name of the local pilot/instructor who will support you during flights, for flight safety. The site management board will verify this with both sides.",
  fSupportPilotPh: "Local pilot/instructor name",
  fSupportPilotPhonePh: "Phone number of the supporting pilot/instructor",
  ...
  err: {
    ...
    emergencyPhone: "Please enter an emergency contact number",
