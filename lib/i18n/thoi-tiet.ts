...
const vi: ThoiTietCopy = {
  ...
  bookPitch: "Nếu bạn muốn học và có nhiều kiến thức về khí tượng dành riêng cho bay lượn — gió núi, thermal, mây, gió đứt, đọc khí tượng trước khi cất cánh — thì nên đọc cuốn sách này. Đây là sách khí tượng kinh điển của dân dù lượn và diều lượn trên thế giới, do Mebayluon dịch và phát hành tiếng Việt.",
