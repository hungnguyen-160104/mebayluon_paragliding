...
export const HI_SELECT_FLIGHT_LOCALE: SelectFlightStepLocale = {
  ...
  ui: {
    ...
    locationDescription: {
      ...
      quan_ba: [
        "हा जियांग पत्थर के पठार के ऊपर हज़ारों मीटर की ऊँचाई पर उड़ें। पैराग्लाइडिंग 1,000 मी से टेक-ऑफ करती है, पैरामोटर क्वान बा घाटी से।",
        "स्वर्ग का द्वार, जुड़वाँ पर्वत, लुंग ताम घाटी और पहाड़ों के तल से बहती नदी देखें। क्वान बा क्षेत्र में राउंड-ट्रिप ट्रांसफ़र शामिल है।",
      ],
    },
