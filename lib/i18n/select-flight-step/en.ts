...
export const EN_SELECT_FLIGHT_LOCALE: SelectFlightStepLocale = {
  ui: {
    ...
    optionalServicesSunsetDesc: "The flight takes place between 16:30–17:30 to catch the sunset. However, weather can change and a sunset is not always guaranteed. If there is no sunset, this fee will be refunded.",
    optionalServicesFlycamNotice: "At Doi Bu (Hanoi), flycam/drone service is sometimes unavailable. DON'T WORRY, after booking, we will confirm its availability with you. If unavailable, the flycam fee will be 100% refunded.",
