...
export const ZH_SELECT_FLIGHT_LOCALE: SelectFlightStepLocale = {
  ...
  ui: {
    ...
    optionalServicesSunsetDesc: "飞行在 16:30–17:30 之间进行，以欣赏日落。但是，天气可能会发生变化，不一定保证能看到日落。如果没有日落，该费用将被退还。",
    optionalServicesFlycamNotice: "在河内 Đồi Bù 飞行点，无人机 (flycam) 服务有时可能不可用。请放心，预订后我们将与您确认是否有无人机服务。如果没有，无人机费用将获得 100% 退款。",
