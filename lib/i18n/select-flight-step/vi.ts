...
export const VI_SELECT_FLIGHT_LOCALE: SelectFlightStepLocale = {
  ...
  ui: {
    ...
    optionalServicesSunsetDesc: "Chuyến bay được thực hiện trong khung giờ 16:30–17:30 để đón khoảnh khắc hoàng hôn. Tuy nhiên, thời tiết có thể thay đổi và không phải lúc nào cũng có hoàng hôn như dự đoán. Nếu không có hoàng hôn, chi phí này sẽ được hoàn lại.",
    optionalServicesFlycamNotice: "Tại điểm bay Đồi Bù, Hà Nội, dịch vụ flycam/drone camera đôi khi không có sẵn. ĐỪNG LO, sau khi đặt chỗ, chúng tôi sẽ xác nhận có sẵn dịch vụ flycam cho bạn hay không. Nếu không có, phí flycam sẽ được hoàn lại 100%.",
    ...
    mapKhauPhaTakeoffLabel: "Đỉnh đèo Khau Phạ - Xem bản đồ",
    mapKhauPhaLandingLabel: "Điểm hạ cánh Clubhouse - Xem bản đồ",
    mapKhauPhaClubhouseLabel: "Clubhouse Mebayluon - Xem bản đồ",
    mapDaNangTakeoffLabel: "Đỉnh Sơn Trà - Xem bản đồ",
    mapDaNangLandingLabel: "Miếu thờ Ngư Ông - Xem bản đồ",
