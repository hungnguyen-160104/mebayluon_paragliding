...
export const RU_SELECT_FLIGHT_LOCALE: SelectFlightStepLocale = {
  ...
  ui: {
    ...
    locationDescription: {
      ...
      quan_ba: [
        "Площадка Куан Ба – Хазянг, Mebayluon работает здесь с 15 октября 2026: старт на параплане с 950 м, парамотор стартует прямо в долине.",
        "Полёт над каменным плато: Небесные врата, Горы-близнецы, долина Лунг Там и река у подножия гор. Трансфер туда-обратно в районе Куан Ба включён.",
      ],
    },
    ...
    quanBaPickupWarning:
      "Примечание: трансфер туда-обратно в районе Куан Ба уже включён в билет. Если вы снимете галочку и приедете сами, пожалуйста, будьте на месте встречи за 15 минут.",
    ...
    mapKhauPhaTakeoffLabel: "Вершина Кхау Фа - Открыть карту",
    ...
    mapQuanBaTakeoffLabel: "Старт параплана Куан Ба (950 м) - Открыть карту",
    mapQuanBaLandingLabel: "Поле посадки / старт парамотора - Открыть карту",
    temporarilyClosed: "Временно закрыто",
  },
  locationCards: {
    ha_noi: { title: "ХАНОЙ", subtitle: "Дой Бу - Виен Нам" },
    khau_pha: { title: "КХАУ ФА", subtitle: "Мукангчай - Ту Ле" },
    sapa: { title: "САПА", subtitle: "Лао Чай - Та Ван" },
    quan_ba: { title: "ХА ЗЯНГ", subtitle: "Куан Ба" },
    da_nang: { title: "ДАНАНГ", subtitle: "Полуостров Шонча" },
  },
};