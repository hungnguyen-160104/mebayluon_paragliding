...
export const RU_SELECT_FLIGHT_LOCALE: SelectFlightStepLocale = {
  ...
  ui: {
    ...
    locationDescription: {
      ...
      quan_ba: [
        "Полёт над каменным плато Хазянг на высоте тысяч метров. Параплан стартует с 1 000 м, парамотор стартует из долины Куан Ба.",
        "Небесные врата, Горы-близнецы, долина Лунг Там и река у подножия гор. Трансфер туда-обратно в районе Куан Ба включён.",
      ],
    },
