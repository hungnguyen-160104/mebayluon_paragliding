...
const T: Record<EmailLang, Dict> = {
  vi: {
    ...
    guideBring: "Giấy tờ tuỳ thân, kính râm, áo khoác mỏng, túi nhỏ 1–2 kg. Điện thoại còn trống ~10GB để chép ảnh & video.",
  ...
  en: {
    ...
    guideBring: "ID or passport, sunglasses, a light jacket, a small 1–2 kg bag. Phone with ~10GB free for your photos and video.",
  ...
  fr: {
    ...
    guideBring: "Pièce d'identité, lunettes de soleil, veste légère, petit sac de 1 à 2 kg. Téléphone avec ~10 Go libres pour vos photos et vidéos.",
  ...
  ru: {
    ...
    guideBring: "Документ, очки от солнца, лёгкая куртка, небольшая сумка 1–2 кг. Телефон со свободными ~10 ГБ для фото и видео.",
  ...
  zh: {
    ...
    guideBring: "身份证件、墨镜、薄外套、1–2 公斤随身小包。手机预留约 10GB 空间用于拷贝照片和视频。",
  ...
  hi: {
    ...
    guideBring: "पहचान पत्र, धूप का चश्मा, हल्की जैकेट, 1–2 किग्रा का छोटा बैग। फ़ोटो-वीडियो के लिए ~10GB खाली फ़ोन।",
