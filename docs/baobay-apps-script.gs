/**
 * Apps Script cho trang báo bay nội bộ — bản `baobay-multispot-v7`.
 *
 ...
 * Hướng dẫn từng bước: docs/baobay-apps-script.md
 */
...
// "Mã bảo vệ" của điểm bay tương ứng ở /baobay/admin.
